...
A função dotprod é ativada quando o thread é criado.
 ...
 do tipo DOTDATA e toda a saída desta função é escrita em
 esta estrutura. O benefício desta abordagem é evidente para o
 ...
 */  
 ...
 /* 
O programa principal cria tópicos que fazem todo o trabalho e depois
 imprimir o resultado após a conclusão. Antes de criar os tópicos,
 ...
 */
 ...
 int main (int argc, char *argv[])
 {
    ...
    /* Crie tópicos para executar o produto pontocom */
